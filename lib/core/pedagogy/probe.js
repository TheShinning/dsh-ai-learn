...
import { PROBE_DEPTH_MAX } from '../types.js'
                                                        
import { evidenceTone } from '../knowledge/evidence.js'
...
export const INITIAL_PROBE_STATE             = {
  probeDepth: 0,
...
export function normalizeProbeState(input                             )             {
 ...
 */
export function deriveProbeState(evidence                     , nodeId         )             {
 ...
 */
export function depthDirective(depth            )         {
  switch (depth) {
    case 0:

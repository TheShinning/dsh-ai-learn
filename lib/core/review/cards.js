...
export function judgementMode(card           )                {
 ...
 * 与卡片类型无关。
 */
export function isPracticable(card           )          {
...
export function impracticableReason(card           )                     {
 ...
 */
export function resolveChoiceKey(card            )                     {
 ...
 * - 其他类型：用调用方给的自评结果。
 */
export function judge(card           , response                                                  )                        {
  if (card.kind === 'choice') {
